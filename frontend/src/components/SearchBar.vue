...
<template>
  <div class="bg-primary px-3 py-3 pb-4">
    <div class="position-relative mx-auto" style="max-width: 600px;">
      <input
        type="search"
        class="form-control ps-5 border-0 rounded"
        placeholder="Search snippets by keyword, tag, or full-text"
        :value="modelValue"
      ...
      <!-- Magnifier icon — https://www.svgrepo.com/svg/263197/magnifying-glass-search -->
  <svg class="position-absolute top-50 start-0 translate-middle-y ms-3"
     width="18" height="18" viewBox="0 0 491.52 491.52"
     xmlns="http://www.w3.org/2000/svg">
  <ellipse style="opacity:0.5;fill:#27A2DB;" cx="158.537" cy="158.536" rx="129.777" ry="129.777"/>
  <path style="opacity:0.5;fill:#FFFFFF;" d="M98.081,234.62c-43.316-43.315-43.882-112.979-1.264-155.595
